"""
This is code to generate and run a 20-minute stimulus for habituation.
...
SESSION_PARAMS = {'type': 'hab', # type of session (hab or ophys)
                  ...
                  'session_dur': 20*60, # expected total session duration (sec)
                  ...
                  'gab_dur': 9*60, # duration of gabor block (sec)
                  'sq_dur': 4.5*60, # duration of each brick block (total=2) (sec)
                  }
