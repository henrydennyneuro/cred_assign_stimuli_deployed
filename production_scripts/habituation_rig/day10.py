"""
This is code to generate and run a 50-minute stimulus for habituation.
...
SESSION_PARAMS = {'type': 'hab', # type of session (hab or ophys)
                  ...
                  'gab_dur': 24*60, # duration of gabor block (sec)
                  'sq_dur': 12*60, # duration of each brick block (total=2) (sec)
                  }
