"""
This is code to generate and run a 10-minute stimulus for habituation.
...
SESSION_PARAMS = {'type': 'hab', # type of session (hab or ophys)
                  ...
                  'session_dur': 10*60, # expected total session duration (sec)
                  ...
                  'gab_dur': 4*60, # duration of gabor block (sec)
                  'sq_dur': 2*60, # duration of each brick block (total=2) (sec)
                  }
