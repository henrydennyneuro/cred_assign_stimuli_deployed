"""
This is code to generate and run a 30-minute stimulus for habituation.
...
SESSION_PARAMS = {'type': 'hab', # type of session (hab or ophys)
                  ...
                  'session_dur': 30*60, # expected total session duration (sec)
                  ...
                  'gab_dur': 14*60, # duration of gabor block (sec)
                  'sq_dur': 7*60, # duration of each brick block (total=2) (sec)
                  }
