...
if __name__ == "__main__":
    ...
    SESSION_PARAMS_type = json_params.get('type', 'hab')
    SESSION_PARAMS_session_dur = json_params.get('session_dur', 50*60)
    SESSION_PARAMS_pre_blank = json_params.get('pre_blank', 30)
    SESSION_PARAMS_post_blank = json_params.get('post_blank', 30)
    SESSION_PARAMS_inter_blank = json_params.get('inter_blank', 30)
    ...
    SESSION_PARAMS = {'type': SESSION_PARAMS_type, # type of session (hab or ophys)
                  ...
                  # AMENDED FOR PRODUCTION V2
                  'session_dur': SESSION_PARAMS_session_dur, # expected total session duration (sec)
                  'pre_blank': SESSION_PARAMS_pre_blank, # blank before stim starts (sec)
                  'post_blank': SESSION_PARAMS_post_blank, # blank after all stims end (sec)
                  'inter_blank': SESSION_PARAMS_inter_blank, # blank between all stims (sec)
